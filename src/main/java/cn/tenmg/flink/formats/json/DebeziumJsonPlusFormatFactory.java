 ...
 */
@Internal
public class DebeziumJsonPlusFormatFactory
    ...
    public DecodingFormat<DeserializationSchema<RowData>> createDecodingFormat(
        ...
        final boolean schemaInclude = formatOptions.get(DebeziumJsonFormatOptions.SCHEMA_INCLUDE);

        final boolean ignoreParseErrors = formatOptions.get(DebeziumJsonFormatOptions.IGNORE_PARSE_ERRORS);

        final TimestampFormat timestampFormat =
                JsonFormatOptionsUtil.getTimestampFormat(formatOptions);

        return new DebeziumJsonPlusDecodingFormat(schemaInclude, ignoreParseErrors, timestampFormat);
    }
    ...
    public EncodingFormat<SerializationSchema<RowData>> createEncodingFormat(
        ...
        String mapNullKeyLiteral = formatOptions.get(DebeziumJsonFormatOptions.JSON_MAP_NULL_KEY_LITERAL);
